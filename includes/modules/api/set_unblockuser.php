...
$sql = "DELETE FROM `user_blocked` WHERE user_id='$used_in_profile_id' and blocked_user_id='$blocked_user_id'";
$query = $DB->prepare($sql);
$query->execute();

build_history_log($used_in_profile_id,"blocked_remove", $blocked['user_id']);
