...
<div class="col-md-9 col-sm-9">
        ...
        <table class="table">
 <tr><td>' . TEXT_PROFILE_LOCATION.':</td><td>'.get_city_name($user_profile['user_city_id'],$user_profile['user_country']).'</td></tr>
...
foreach ($get_galerie_image as  $galerie_image){
    ...
    if($galerie_image['media_type']==1) {
		...
		<div class="col-md-5 col-sm-12 content-box-right">
			<div class="row">
				<h4 class="profile">' . TEXT_DASHBOARD_HEADLINE_SHOUTBOX_PROFILE.':</h4>
				<div class="col-md-12 col-sm-12">
        ...
        <div class="col-md-5 col-sm-12 content-box-right">
			<div class="row">
				<h4 class="profile">' . TEXT_DASHBOARD_HEADLINE_MARKETPLACE_PROFILE.':</h4>
				<div class="col-md-12 col-sm-12">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                         <header class="list-group-item active start_register_header"><strong>' . TEXT_PROFILE_ALERT.'</strong>: </header>
...
var locations = [[\'<div class="map_box"><strong>'.addslashes($user_profile['user_nickname']).'</strong><br/>in 0.08km<br/><a href="#">weitere Informationen</a></div>\',' . $user_profile['user_lat'].',' . $user_profile['user_lng'].',2]];
    var $latitude = ' . $user_profile['user_lat'].', 
        $longitude = ' . $user_profile['user_lng'].',
        $map_zoom = 13;
        </script>
