...
if(isset($_POST['update_settings'])) {
	...
	header("Location: ".SITE_URL."me/settings/newsletter/");
    die();
...
<form method="post" action="#SITE_URL#me/settings/newsletter/">
';

$settings_types= array(	'email_newsletter' => 'checkbox', 
						'email_searches' => 'checkbox');
						
$radius_distances = array(0,10,25,50,100,200);

$setting_headlines = array();

$sql = "SELECT * FROM user_settings WHERE user_id = '".$_SESSION['user']['user_id']."' AND settings_type='email'  ORDER BY settings_type ASC, settings_key ASC";
$query = $DB->prepare($sql);
$query->execute();
