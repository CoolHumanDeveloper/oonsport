...
function geo_locate_by_input($geo_input) {
    ...
    $url = 'https://maps.googleapis.com/maps/api/geocode/json?address='.urlencode($geo_input).'&key=AIzaSyCf73WkGWTzIZewfQIo6YHkhuBj8uxcfwo&language='.$_SESSION['language_code'];
    //echo $geo_input.'<br>';
